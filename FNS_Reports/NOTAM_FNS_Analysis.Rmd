...
- Generate staffing models (Type 1, 90th percentile demand day), by service area 
...
# Add to dt_hr the staffing models.
# Staffing Models
...
# For the dynamic staffing models, we need to add season, weekend/weekday, and intraday periods to orig_df_hr data frame.
orig_dt_hr <- dt_hr %>%
