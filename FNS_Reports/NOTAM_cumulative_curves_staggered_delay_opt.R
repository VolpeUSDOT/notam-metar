...
# This version optimizes based on staggered starts, with each staff member able to start at arbitrary times, working for an 8 hour shift
...
# Find percentile days across the whole NAS, by weekend and season
